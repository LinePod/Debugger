...
import {GPGLBatch} from './GPGLBatch';
...
export function PlotterView(props: PlotterViewProps) {
    ...
    return (<svg viewBox={viewBox} style={{width: '100vmin', height: '100vmin'}}>
        <rect x='0' y='0' width={widthInSteps} height={heightInSteps} style={{fill: 'none', stroke: 'black', strokeWidth: 5}}/>
